...
public class ProfissionalTest {
    ...
    public void testConstructor(){
        ...
        //Construtor parametrizado com Map
        Map<String, Atividade> atividades = new HashMap<>();
        PlanoDeTreino plano = new PlanoDeTreino();
        Profissional profissional2 = new Profissional("001", 70, 75.5, 175, "João", Genero.Masculino, "Rua X", "joao@example.com", "senha", atividades, plano);
        ...
        Profissional profissional3 = new Profissional("001", 70, 75.5, 175, "João", Genero.Masculino, "Rua X", "joao@example.com", "senha");
    ...
    public void fatorMultiplicativoTest(){
        Profissional profissional = new Profissional("001", 70, 75.5, 175, "João", Genero.Masculino, "Rua X", "joao@example.com", "senha");
