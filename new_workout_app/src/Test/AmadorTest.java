...
public class AmadorTest {
    ...
    public void testConstructor(){
        ...
        Amador amador2 = new Amador("001", 70, 75.5, 175, "João", Genero.Masculino, "Rua X", "joao@example.com", "senha",atividades, plano);
        ...
        Amador amador3 = new Amador("001", 70, 75.5, 175, "João", Genero.Masculino, "Rua X", "joao@example.com", "senha");
    ...
    public void fatorMultiplicativoTest(){
        Amador amador = new Amador("001", 70, 75.5, 175, "João", Genero.Masculino, "Rua X", "joao@example.com", "senha");
